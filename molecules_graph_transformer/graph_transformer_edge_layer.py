...
class MultiHeadAttentionLayer(nn.Module):
    def __init__(self, in_dim, out_dim, num_heads, use_bias):
        ...
        if use_bias:
            ...
            self.proj_spatial_pos = nn.Linear(in_dim, out_dim * num_heads, bias=True)
        else:
    ...
    def forward(self, g, h, e, spatial_pos):
        ...
        g.edata['proj_spatial_pos'] = proj_spatial_pos.view(-1, self.num_heads, self.out_dim)
...
class GraphTransformerLayer(nn.Module):
    ...
    def forward(self, g, h, e, spatial_pos):
        ...
        h_attn_out, e_attn_out = self.attention(g, h, e, spatial_pos)
