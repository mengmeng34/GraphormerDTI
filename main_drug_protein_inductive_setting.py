...
def show_result(DATASET, lable, Accuracy_List, Precision_List, Recall_List, AUC_List, AUPR_List):
    ...
    with open("./{}_drug_protein_inductive_setting/results.txt".format(DATASET), 'w') as f:
...
if __name__ == "__main__":
    ...
    drug_dataset = MoleculeDataset(DATASET + '_drug_protein_inductive_setting_' + str(SEED))
    ...
    save_path = "./" + DATASET + "_drug_protein_inductive_setting"
    note = ''
